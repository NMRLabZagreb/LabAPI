    ...
    def set_routes(self):
        ...
        def get_temperature():
            if request.method == 'POST':
                response_value = self.ls.get_temperature(int(request.json['control_channel']))
                return jsonify({'temperature': response_value}), 200
            elif request.method == 'GET':
                response_value = self.ls.get_temperature(int(request.args['control_channel']))
                return str(response_value), 200
            
        @blueprint.route('/get_sensor', methods=['GET', 'POST'])
        def get_sensor():
            if request.method == 'POST':
                response_value = self.ls.get_sensor(int(request.json['control_channel']))
                return jsonify({'sensor': response_value}), 200
            elif request.method == 'GET':
                response_value = self.ls.get_sensor(int(request.args['control_channel']))
                return str(response_value), 200
        ...
        def get_heater_range():
            response_value = self.ls.get_heater_range()
            if request.method == 'POST':
        ...
        def get_heater_percent():
            response_value = self.ls.get_heater_percent()
            if request.method == 'POST':
        ...
        def get_heater_percent_fullrange():
            response_value = self.ls.get_heater_percent_fullrange()
            if request.method == 'POST':
        ...
        def get_pid():
            ...
            if request.method == 'POST':
                ...
                return f'{response_value[0]:d}, {response_value[1]:d}, {response_value[2]:d}', 200
        ...
        def set_setpoint():
            if request.method == 'POST':
                self.ls.set_setpoint(int(request.json['setpoint']),float(request.json['control_loop']))
                return jsonify({}), 200
            elif request.method == 'GET' or request.method == "PUT":
                self.ls.set_setpoint(int(request.args['setpoint']),float(request.args['control_loop']))
                return str(""), 200
            
        @blueprint.route('/set_heater_range', methods=['GET', 'PUT', 'POST'])
        def set_heater_range():
            if request.method == 'POST':
                self.ls.set_heater_range(int(request.json['range_index']))
                return jsonify({}), 200
            elif request.method == 'GET' or request.method == 'PUT':
                print(request.args)
                self.ls.set_heater_range(int(request.args['range_index']))
                return str(""), 200
        ...
        def set_ramp_rate():
            if request.method == 'POST':
                self.ls.set_ramp_rate(int(request.json['ramp_rate']),float(request.json['control_loop']))
                return jsonify({}), 200
            elif request.method == 'GET' or request.method == "PUT":
                self.ls.set_ramp_rate(int(request.args['ramp_rate']),float(request.args['control_loop']))
                return str(""), 200
            
        @blueprint.route('/set_manual_output', methods=['GET', 'PUT', 'POST'])
        def set_manual_output():
            if request.method == 'POST':
                self.ls.set_setpoint(int(request.json['manual_out']),float(request.json['control_loop']))
                return jsonify({}), 200
            elif request.method == 'GET' or request.method == "PUT":
                self.ls.set_setpoint(int(request.args['manual_out']),float(request.args['control_loop']))
                return str(""), 200
